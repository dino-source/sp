#ifndef CHAPTER_02_EXERCISE_06_H
#define CHAPTER_02_EXERCISE_06_H

// Stephen Prata's "C++ Primer Plus" (Sixth Edition). Chapter 2. Exercise 6.
...
namespace ch02::ex06
{
    inline double light_years_to_astronomical_units(double light_years)
    {
    ...
    inline void run_space_distance_units_converter()
    {
        double light_years;
        std::cout << "Enter the number of light years: ";
        (std::cin >> light_years).get();
...
#endif // CHAPTER_02_EXERCISE_06_H
